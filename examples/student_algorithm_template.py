...
4. 제한시간(기본 10초)을 넘기면 실격 처리(직전 라인업 또는 기본 출전으로 자동 대체)됩니다.
   population/generation/tabu iteration은 넉넉히 pop<=100, gens<=200, tabu iters<=300
   수준을 권장합니다 (사전 벤치마크 기준 대부분 1초 이내).
